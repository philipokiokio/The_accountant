...
async def create_platform(
    ...
    return await investment_service.create_platform(
        platform=platform, user_group_uid=user_profile.user_group_uid
    )
...
async def get_platforms(
    ...
    return await investment_service.get_platforms(
...
async def get_platform(
    ...
    return await investment_service.get_platform(
        user_group_uid=user_profile.user_group_uid, platform_uid=platform_uid
    )
...
@api_router.post(
    path="-trackers/{platform_uid}/inv/{investment_id}",
    response_model=schemas.InvestmentProfile,
    status_code=status.HTTP_201_CREATED,
)
async def create_investment_tracker(
    platform_uid: UUID,
    investment_uid: schemas.Investment,
